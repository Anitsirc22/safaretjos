var en = {
  ...
  "Perceptions": "Perceptions",
	...
	'content_identity_text':'Collecting data is not only a matter of assigning a number to everything. One must be critic before drawing conclusions on the data. What is really identity for each person? Since it does not exist a clear answer, several questions were asked to the neighbours in order to get an approach to their feelings for the neighbourhood. Each of them was answered with a number in the range from 0 (really negative) to 10 (really positive).<br><br>How would you value…<br><i>your relationship with your neighbours?</i><br><i>your involvement in the neighborhood\'s associative fabric?</i><br><i>your appreciation for the neighborhood?</i><br><i>your experiences in the neighborhood?</i><br><br>Open questions such as how they would describe the place in a few words were also conducted to get a better understanding of the numbers.<br>After analysing the cases, an average number from the answers obtained was finally assigned to visualize the feeling of identity in the neighbourhood.',
	'content_perceptions_title':'Do invisible borders exist in Safaretjos?',
	'content_perceptions_text':'Human brains are constantly processing millions of inputs that we encounter every day in the new dynamic cities. Collecting active data based on perceptions is a step forward. Each person has a different perception of the constantly changing world we are living in.<br>Not only territories are divided by municipality boundaries. The consequences of architectural decisions can also become invisible borders in the city, which can affect the behaviour and perceptions of their citizens.<br>The data has been collected by multiple drawings after several discussions with the neighbours.<br>The map is an attempt to make the invisible visible. In other words, it tries to visualize what the neighbours experience and perceive by their senses.',
	'content_social_title':'Is Safaretjos a community?',
	'content_social_text':'As human beings, we need a sense of belonging, and that sense of belonging is what connects us to the many relationships we develop.<br>Communities allows us to support one another, interact, share experiences, builds valuable relationships…<br>We are all members of many communities (family, work, neighborhood, etc.), and we constantly move in and out of them, depending on the situation.<br>The main goal here was to try identify if there exists a community in Safaretjos. To respond that question, the citizens where asked how many people they know in the neighbourhood, what activities did they do together and how often they meet.<br>The map shows a network that represents the social relationships within the neighbourhood.',
	'content_paths_title':'How citizens move in Safaretjos?',
	'content_paths_text':'Humans are constantly on the move. Most of us would agree that movement, at root, is a powerful sign of human vitality.<br>In order to map citizen flows, the neighbours were asked to draw the paths that they often take to carry out their daily activities as well as the mean of transport used.<br>Most of them tend to move and spend part of the day in Sant Adrià and Badalona rather than to its own city.',
	'content_local_title':'Should administrative boundaries be modified?',
	'content_local_text':'Safaretjos is a territory that is located eccentrically from its city Santa Coloma de Gramenet. Most of the facilities located in a walking distance belong to other municipalities.<br>It is not easy to find a spot in the public schools close to the neighbourhood since those don’t belong to Santa Coloma. The same issue happens when citizens need to make use of any public service.<br>The data that has been collected shows how people make use of local facilities regardless of their municipality. In the graph, we can find the comparison of the facilities that neighbours use according to its municipality.<br>The map questions the role that administrative boundaries play in the neighbourhood and proposes solutions such as shared use agreements for schools, primary care centres, and other services.',
	'content_metro_title':'What role plays Safaretjos on a <br>metropolitan scale?',
	'content_metro_text':'The situation of Safaretjos is strategic at a metropolitan scale and, more specifically, in the Besòs Territory. Because of its ability to centrality and metropolitan kneecap it becomes a centrepiece of the Besós Plan.<br>In order to visualize citizen flows in a metropolitan scale, the neighbours were asked about their movements towards other municipalities due to work, family, studies and leisure reasons.',
};